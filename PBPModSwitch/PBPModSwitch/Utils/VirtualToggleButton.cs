...
namespace PBPModSwitch.Utils
{
    public static class VirtualToggleButton
    {
        ...
        /// </summary>
        public static readonly DependencyProperty s_isCheckedProperty =
        ...
        {
            return (Nullable<bool>)d.GetValue(s_isCheckedProperty);
        }
        ...
        {
            d.SetValue(s_isCheckedProperty, value);
        }
        ...
        /// </summary>
        public static readonly DependencyProperty s_isThreeStateProperty =
        ...
        {
            return (bool)d.GetValue(s_isThreeStateProperty);
        }
        ...
        {
            d.SetValue(s_isThreeStateProperty, value);
        }
        ...
        /// </summary>
        public static readonly DependencyProperty s_isVirtualToggleButtonProperty =
        ...
        {
            return (bool)d.GetValue(s_isVirtualToggleButtonProperty);
        }
        ...
        {
            d.SetValue(s_isVirtualToggleButtonProperty, value);
        }
